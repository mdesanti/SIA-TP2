...
public class GameGenerator {
	public static void main(final String[] args) throws Exception {
		...
		xml.nodes.put(new Point(0, 2), new GameXML.GameNode(0, 0, 1, 1));
		xml.nodes.put(new Point(1, 0), new GameXML.GameNode(1, 1, 1, 0));
		xml.nodes.put(new Point(1, 1), new GameXML.GameNode(1, 1, 1, 1));
		xml.nodes.put(new Point(1, 2), new GameXML.GameNode(1, 0, 1, 1));
		xml.nodes.put(new Point(2, 0), new GameXML.GameNode(1, 1, 0, 0));
		xml.nodes.put(new Point(2, 1), new GameXML.GameNode(1, 1, 0, 1));
